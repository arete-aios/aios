...
```
KW7 {keyword} or KW7 traffic {domain}. Real search demand: volume, 12 month curve, CPC, competitor organic traffic. Always name which source measured what, and which country. Spec: skills/kw7/SKILL.md
```
